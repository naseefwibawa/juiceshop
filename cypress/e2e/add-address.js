...
describe('Add address', () => {
	...
	it('add address', () => {
		...
		cy.get('[placeholder="Please provide a country."]').type('UK')
		...
		cy.get('#address').type('Norwegian pasar gede')
		cy.get('[placeholder="Please provide a city."]').type('londonism')
		...
		cy.get('.mat-simple-snack-bar-content').should(
			'contain',
			'The address at londonism has been successfully added to your addresses.'
		)
	})
